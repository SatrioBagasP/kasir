<div class="bg-white dark:bg-gray-700 p-4 sm:ml-64 bg-white ">
    <div class="">
        ...
        <center>
            <h1 class="mb-10 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Total Penjualan</h1>
        </center>
        <div class="grid grid-cols-2 gap-4 mb-4">
            <?php foreach ($data['barang'] as $list) : ?> 
                ...
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><?= $list['nama_barang'] ?></h5>
                <p class="font-normal text-gray-700 dark:text-gray-400">Jumlah Barang Terjual <span class="font-30 font-bold tracking-tight text-gray-900 dark:text-white"><?= $list['jumlah_barang'] ?></span>
                </p>
            </div>
            <?php endforeach ?>
        </div>
